...
class IncongruenceDetectorScreen extends StatefulWidget {
  ...
  State<IncongruenceDetectorScreen> createState() =>
      _IncongruenceDetectorScreenState();
}
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final bottomSafePadding = MediaQuery.paddingOf(context).bottom + 28;
                      ...
                      child: Row(
                        children: [
                          ...
                          ChoiceChip(
                            ...
                            selectedColor: AppColors.primary,
                            labelStyle: TextStyle(
                              color: _selectedAudience == 'autism_focus'
                                  ? Colors.white
                                  : (isDark
                                      ? AppColors.textPrimaryDark
                                      : AppColors.textPrimaryLight),
                          ...
                          ChoiceChip(
                            ...
                            selectedColor: AppColors.primary,
                            labelStyle: TextStyle(
                              color: _selectedAudience == 'sales_focus'
                                  ? Colors.white
                                  : (isDark
                                      ? AppColors.textPrimaryDark
                                      : AppColors.textPrimaryLight),
