  ...
  void _confirmResetProgress() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'Se borrarán tus puntos, racha, marcas de señales exploradas y marcadores.'),
        actions: [
          TextButton(
              ...
              child: ListView(
                ...
                children: [
                          ...
                          DropdownMenuItem(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text('Automático (Idioma del Sistema)',
                                    style:
                    ...
                    child: Column(
                      children: [
                        SwitchListTile(
                          ...
                          subtitle: const Text(
                              'Bordes reforzados y texto de máxima legibilidad'),
                        ...
                        SwitchListTile(
                          ...
                          subtitle: const Text(
                              'Tinte sepia suave para reducir fatiga'),
                        ...
                        SwitchListTile(
                          ...
                          subtitle: const Text(
                              'Vibración ligera al interactuar y confirmar'),
                        ...
                        SwitchListTile(
                          ...
                          subtitle: const Text(
                              'Sonidos suaves de acierto, error y confirmación'),
                  ...
                  const SectionHeader(
                    ...
                    subtitle:
                        'Haz que la lectura sea 100% opcional escuchando el contenido',
                  ),
                  AppCard(
                    padding: const EdgeInsets.all(12),
                    child: Column(
                      children: [
                        SwitchListTile(
                          title: const Text('Modo Auto-Narración',
                              style: TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: const Text(
                              'Lee automáticamente en voz alta preguntas, escenarios, tarjetas y explicaciones al entrar'),
                          ...
                          onChanged: (val) {
                            ...
                            if (val) {
                              TtsService.speak(
                                  'Modo de auto-narración activado. Ahora Gestura te leerá todo el contenido automáticamente.');
                            } else {
                              TtsService.stop();
                            }
                          },
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  const Text('Velocidad de Lectura TTS:',
                                      style: TextStyle(
                              ...
                              Align(
                                ...
                                child: TextButton.icon(
                                  onPressed: () {
                                    FeedbackService.lightClick();
                                    TtsService.speak(
                                        'Esta es una prueba de velocidad de voz en Gestura.');
                                  },
                  ...
                  AppCard(
                    ...
                    child: ListTile(
                      ...
                      subtitle: const Text(
                          'Elimina historial de respuestas y marcas'),
